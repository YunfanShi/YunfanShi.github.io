...
const required = [
  ...
  '完整学习主线', '一次学习怎么走', '学习后怎么复习', '卡住时走哪条路',
  '确定结果', '理解知识', '建立连接', '应用与迁移', '检测并回退',
  '查看详细说明', 'renderExpandedDetails', '为什么：', '怎么做：', '例子：',
...
if ((html.match(/data-tab="/g) || []).length !== 6) throw new Error('Study Guide must keep exactly six primary tabs');
if ((html.match(/renderExpandedDetails\(/g) || []).length < 7) throw new Error('Study Guide expandable explanations are not wired to every content renderer');
