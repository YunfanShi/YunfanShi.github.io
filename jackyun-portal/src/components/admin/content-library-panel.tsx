  ...
  function createCodes(formData: FormData) {
    start(async () => {
      ...
      const result = await createRedemptionCodes({
        ...
        novelIds: rewardType === 'novel' ? selectedNovelIds : undefined, planCode: rewardType === 'membership' ? planCode : undefined,
