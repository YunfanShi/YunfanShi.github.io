  ...
  return <div className="page-enter mx-auto max-w-7xl">
    ...
    <div className="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
      ...
      <main className="min-w-0 space-y-5">
        ...
        {active === 'companion' && <Panel title="Companion 与同步" description={isGuest ? '登录后才能绑定扩展设备和同步学习活动。' : '管理扩展、设备、有效时间统计和同步隐私。'}>{isGuest ? <Link href="/login?next=/settings?section=companion" className="inline-flex rounded-xl bg-[#1a73e8] px-4 py-2.5 text-sm font-semibold text-white">登录后管理 Companion</Link> : <CompanionSettingsPanel initialPreferences={settings.companion_preferences || {}} devices={props.companionDevices} />}</Panel>}
