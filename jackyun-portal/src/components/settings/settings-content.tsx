  ...
  return <div className="page-enter mx-auto max-w-7xl">
    ...
    <div className="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
      ...
      <main className="min-w-0 space-y-5">
        ...
        {active === 'advanced' && <><Panel title="高级设置" description="稳定版与预览版现在有明确发布通道；预览功能只有在单独标记后才会出现在预览通道。"><CloudPreferencesPanel sectionKey="advanced_preferences" initialValue={{ diagnostics: false, releaseChannel: settings.advanced_preferences?.betaFeatures === true ? 'preview' : 'stable', ...(settings.advanced_preferences || {}) }} fields={[{ key: 'diagnostics', label: '诊断信息', description: '发生错误时保存不含正文和密码的技术信息', type: 'boolean' }, { key: 'releaseChannel', label: '发布通道', description: '当前没有待测功能；选择预览版不会把未标记功能提前上线', type: 'select', options: [{ value: 'stable', label: '稳定版（推荐）' }, { value: 'preview', label: '预览版' }] }]} /></Panel><BugReportPanel /><LoggerViewerWrapper /></>}
