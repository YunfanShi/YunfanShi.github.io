...
const translations: TranslationMap = {
  ...
  'nav.control-center':       { zh: '控制中心',             en: 'Control Center' },
  ...
  'nav.countdown':            { zh: '倒计时',               en: 'Countdown' },
  'nav.relax':                { zh: '放松一下',             en: 'Relax' },
  'nav.schedule':             { zh: '日程中心',             en: 'Schedule' },
  ...
  'nav.exam-countdown':       { zh: '考试倒计时',           en: 'Exam Countdown' },
